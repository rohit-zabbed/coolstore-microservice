...
public class ShoppingCartServiceImplDecisionServer extends ShoppingCartServiceImpl {
  ...
  private static final String PRICING_ENDPOINT = "http://localhost:8180";
  private static final String URL = PRICING_ENDPOINT + "/kie-server/services/rest/server";
  private static final String USER = "kieserver";
  private static final String PASSWORD = "kieserver1!";
  private static final String CONTAINER_ID = "coolstore_2.0.0";
  private static final String KIE_SESSION_NAME = "coolstore-kie-session";
//    private static final String RULE_FLOW_PROCESS_NAME = "com.redhat.coolstore.PriceProcess";
  ...
  void initialize() {
    ...
    extra.add(com.redhat.coolstore.ShoppingCart.class);
    conf.addExtraClasses(extra);
...
//        commands.add(commandsFactory.newStartProcess(RULE_FLOW_PROCESS_NAME));
